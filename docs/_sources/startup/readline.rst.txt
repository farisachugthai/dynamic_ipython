==========================
Setting up :mod:`readline`
==========================

.. currentmodule:: default_profile.startup.readline_
...
However, all that the function does is a simple call to `types.MethodTypes` and
...
Useful to see the ``magic_matches``, ``dict_key_matches``, ``file_matches`` and
...
If so, then that would possibly make it the only use I've seen in the repo of
this. Still unsure of what this class is though.
...
.. automodule:: default_profile.startup.readline_
