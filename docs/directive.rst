...
.. this document is nuts to me. Let's rewrite it. Also take note of the fact
   that IPython has a copy of this document, Matplotlib does too, and so does
   Jupyter. Somehow the one at ipython.readthedocs.com is the most updated one...
