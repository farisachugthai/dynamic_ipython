...
Generated from the following shell command::

    jupyter-nbextensions_configurator --JupyterNbextensionsConfiguratorApp.generate_config=True

Annoyingly the alias for simply --generate-config didn't seem to work.

"""
# Configuration file for jupyter nbextensions_configurator.
